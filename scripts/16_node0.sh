...
vq_path=/data/dyb/pretrained_ckpts/qwen3_vq/model.safetensors
...
run_name="qwen3_uni_wo_stack_w25_rope_2M"
output_dir=/data/dyb/output/qwen3_uni_gen_only_wo_stack_w25_rope_2M
export WANDB_PROJECT="qwen3_uni_gen_only"
...
torchrun --nnodes=2 \
         --nproc_per_node=8 \
         --node_rank=0 \
         --master_addr=10.42.78.161 \
         --master_port=30000 \
         ${entry_file} ${args}


# torchrun --nnodes=1 --node_rank=0 --master_port=30000 ${entry_file} ${args}
